...
<!-- Mirrored from html.creativegigstf.com/babun/babun/index-8.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 May 2026 10:16:12 GMT -->
<head>
	<meta charset="UTF-8">
	...
	<div class="main-page-wrapper">
				...
				<div class="top-header">
					<div class="d-flex align-items-center justify-content-between">
						...
						<div class="right-widget d-none d-md-block ms-auto ms-lg-0 me-3 me-lg-0 order-lg-3">
							<a href="contact.html" class="quote-one fw-500 tran3s">Start Quote</a>
						</div> <!--/.right-widget-->
						<nav class="navbar navbar-expand-lg p0 order-lg-2">
							...
							<div class="collapse navbar-collapse" id="navbarNav">
								<ul class="navbar-nav align-items-lg-center">
									...
									<li class="d-md-none ps-2 pe-2 mt-15"><a href="contact.html" class="btn-one text-center w-100 fw-500 tran3s">Start Quote</a></li>
								</ul>
							</div>
						</nav>
					</div>
		...
		<div class="hero-banner-eight pt-200 lg-pt-150 pb-225 xl-pb-150 lg-pb-150 md-pb-120 sm-pb-20 position-relative z-1">
			<div class="container position-relative">
				<div class="row">
					<div class="col-lg-6 col-md-8">
						<h1 class="hero-heading text-white position-relative wow fadeInUp">Innovative tax solutions ahead.</h1>
						<div class="row">
                            <div class="col-xl-11">
                                <p class="text-xl text-white pt-25 lg-pt-20 pb-40 lg-pb-30 md-pb-20 wow fadeInUp" data-wow-delay="0.1s">Seamlessly integrate teams, tasks, & documents with the all-in-one babun app.</p>
                            </div>
                        </div>
						<div class="d-lg-inline-flex align-items-center wow fadeInUp" data-wow-delay="0.2s">
							<ul class="style-none d-flex flex-wrap align-items-center">
                                <li class="me-3 mt-10"><a href="contact.html" class="btn-twentyOne">Start your free trial</a></li>
                                <li class="mt-10"><a data-fancybox="" href="https://www.youtube.com/embed/aXFSJTjVjw0" class="btn-twentytwo">Watch Video</a></li>
                            </ul>
						</div>
					</div>
				</div>
			...
			<div class="media-wrapper wow fadeInUp">
                <img src="images/lazy.svg" data-src="images/assets/businessman_04.png" alt="" class="lazy-img w-100">
                <img src="images/assets/screen_26.html" alt="" class="shapes shape_01">
                <img src="images/assets/screen_27.html" alt="" class="shapes shape_02">
            </div>
		</div>
		<!-- /.hero-banner-eight -->
		...
		============================================== 
		-->
		<div class="block-feature-sixteen position-relative pt-150 lg-pt-80">
			<div class="container">
				<div class="row">
                    <div class="col-lg-7">
                        <div class="title-one mb-60 lg-mb-30">
                            <h2 class="color-deep">Trusted Tax Attorney, Resolving Taxes Together.</h2>
                        </div>
                        <!-- /.title-one -->
                        <img src="images/lazy.svg" data-src="images/media/img_51.jpg" alt="" class="lazy-img media-img md-mb-40">
                    </div>
                    <div class="col-lg-5">
                        <div class="ps-xl-5 ms-xxl-5">
                            <div class="counter-block-four text-center mb-40 md-mb-20">
                                <div class="main-count color-deep fw-500"><span class="counter">76</span></div>
                                <p class="text-lg color-deep">Trusted Partners</p>
                            </div>
                            <!-- /.counter-block-four -->
                            <div class="counter-block-four text-center mb-40 md-mb-20">
                                <div class="main-count color-deep fw-500">$<span class="counter">9.1</span>bil+</div>
                                <p class="text-lg color-deep">Coverage</p>
                            </div>
                            <!-- /.counter-block-four -->
                            <div class="counter-block-four text-center">
                                <div class="main-count color-deep fw-500"><span class="counter">1.2</span>%</div>
                                <p class="text-lg color-deep">Low interest rate</p>
                            </div>
                            <!-- /.counter-block-four -->
                        </div>
                    </div>
            ...
            <img src="images/lazy.svg" data-src="images/shape/shape_54.svg" alt="" class="lazy-img shapes shape_01">
		</div>
		<!-- /.block-feature-sixteen -->
			...
			<div class="container">
				...
				<div class="portfolio-block-three mt-50 lg-mt-30">
					<div class="d-flex flex-wrap align-items-center">
						...
						<div class="media-img">
							<div class="img"><img src="images/gallery/img_23.html" alt="" class="w-100 tran5s"></div>
						</div>
						<a href="project-details-v1.html" class="title">Cost-effective satisfaction solutions</a>
						<a href="project-details-v1.html" class="rounded-circle arrow-btn d-flex align-items-center justify-content-center tran3s"><img src="images/icon/icon_110.html" alt="" class="tran3s"></a>
					</div>
				</div>
				...
				<div class="portfolio-block-three">
					<div class="d-flex flex-wrap align-items-center">
						...
						<div class="media-img">
							<div class="img"><img src="images/gallery/img_24.html" alt="" class="w-100 tran5s"></div>
						</div>
				...
				<div class="portfolio-block-three">
					<div class="d-flex flex-wrap align-items-center">
						...
						<div class="media-img">
							<div class="img"><img src="images/gallery/img_25.html" alt="" class="w-100 tran5s"></div>
						</div>
				...
				<div class="portfolio-block-three">
					<div class="d-flex flex-wrap align-items-center">
						...
						<div class="media-img">
							<div class="img"><img src="images/gallery/img_26.html" alt="" class="w-100 tran5s"></div>
						</div>
					...
					<div class="col-xl-6 col-lg-8 d-flex">
						<div class="bg-wrapper w-100 md-mb-50">
							...
							<a href="#" class="more-btn mt-60 w-100 d-flex align-items-center justify-content-between tran3s">
								...
								<div class="icon d-flex align-items-center justify-content-center rounded-circle"><img src="images/icon/icon_112.html" alt=""></div>
							</a>
						</div>
						<!-- /.bg-wrapper -->
					</div>
					<div class="col-xl-6 col-lg-4 order-lg-first d-flex">
						<div class="w-100 d-flex align-items-center justify-content-center">
							<a data-fancybox="" href="https://www.youtube.com/embed/aXFSJTjVjw0" class="video-icon rounded-circle d-flex align-items-center justify-content-center tran3s">
								<img src="images/icon/icon_113.html" alt="">
							</a>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-3 col-sm-6 wow fadeInUp">
							<div class="card-style-twentyThree mt-35">
								<img src="images/media/img_53.html" alt="" class="w-100 tran5s">
						...
						<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
							<div class="card-style-twentyThree mt-35">
								<img src="images/media/img_54.html" alt="" class="w-100 tran5s">
								<div class="name tran3s">
						...
						<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.2s">
							<div class="card-style-twentyThree mt-35">
								<img src="images/media/img_55.html" alt="" class="w-100 tran5s">
								<div class="name tran3s">
						...
						<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
							<div class="card-style-twentyThree mt-35">
								<img src="images/media/img_56.html" alt="" class="w-100 tran5s">
								<div class="name tran3s">
			...
			<div class="container">
				<div class="position-relative z-1 wrapper">
					<div class="feedback-slider-seven position-relative z-2">
							...
							<div class="feedback-block-eight">
								<div class="row">
									<div class="col-xl-5 col-lg-6">
										<img src="images/media/img_57.html" alt="" class="media-img m-auto md-mb-40">
									</div>
									<div class="col-lg-6 ms-auto">
										<div class="icon d-flex align-items-center justify-content-center rounded-circle"><img src="images/icon/icon_114.html" alt=""></div>
						...
						<div class="item">
							<div class="feedback-block-eight">
								<div class="row">
									<div class="col-xl-5 col-lg-6">
										<img src="images/media/img_58.html" alt="" class="media-img m-auto md-mb-40">
									</div>
									<div class="col-lg-6 ms-auto">
										<div class="icon d-flex align-items-center justify-content-center rounded-circle"><img src="images/icon/icon_114.html" alt=""></div>
										<blockquote>The Guidance Provided by your Consultants is Top-Notch.</blockquote>
					...
					<ul class="slider-arrows slick-arrow-one d-flex justify-content-between style-none">
						<li class="prev_z slick-arrow d-flex align-items-center justify-content-center"><img src="images/icon/icon_116.html" alt=""></li>
						<li class="next_z slick-arrow d-flex align-items-center justify-content-center"><img src="images/icon/icon_115.html" alt=""></li>
					</ul>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 ms-auto me-auto me-lg-0">
						<img src="images/media/img_59.html" alt="" class="media-img ms-auto sm-mt-50">
					</div>
				</div>
			</div>
...
<!-- Mirrored from html.creativegigstf.com/babun/babun/index-8.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 May 2026 10:16:26 GMT -->
</html>
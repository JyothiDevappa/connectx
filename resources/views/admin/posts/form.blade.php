...
<div class="app-shell">
  ...
  <aside class="sidebar">
    ...
    <nav class="sb-nav">
      ...
      <a href="{{ url('/admin/dashboard/posted_jobs') }}" class="nav-link" data-section="posted_jobs">
      ...
      <a href="{{ url('/admin/dashboard/posts') }}" class="nav-link active" data-section="posts">
        ...
        <div class="form-grid">
          ...
          <div class="form-field">
            ...
            <select name="category" id="category" required>
              <option value="Storytelling" {{ old('category', $post->category) === 'Storytelling' ? 'selected' : '' }}>Storytelling</option>
              <option value="Networking" {{ old('category', $post->category) === 'Networking' ? 'selected' : '' }}>Networking</option>
              <option value="Learning" {{ old('category', $post->category) === 'Learning' ? 'selected' : '' }}>Learning</option>
              <option value="Personal Branding" {{ old('category', $post->category) === 'Personal Branding' ? 'selected' : '' }}>Personal Branding</option>
              <option value="Collaboration" {{ old('category', $post->category) === 'Collaboration' ? 'selected' : '' }}>Collaboration</option>
              <option value="Career Growth" {{ old('category', $post->category) === 'Career Growth' ? 'selected' : '' }}>Career Growth</option>
              <option value="Entrepreneurship" {{ old('category', $post->category) === 'Entrepreneurship' ? 'selected' : '' }}>Entrepreneurship</option>
            </select>
          </div>

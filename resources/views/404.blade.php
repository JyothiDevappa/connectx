...
<!-- Mirrored from html.creativegigstf.com/babun/babun/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 May 2026 10:16:32 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="main-page-wrapper">
        ...
        <div class="error-page text-center d-flex align-items-center justify-content-center flex-column light-bg position-relative">
            ...
            <div><a href="index.html" class="btn-four">Go Back</a></div>
                ...
                <div class="container">
                    <div class="user-data-form modal-content">
                        ...
                        <div class="form-wrapper m-auto">
                            ...
                            <p class="text-center fs-6 mt-10">Have an account? <a href="#" class="fw-500"
                                    data-bs-toggle="modal" data-bs-target="#loginModal">Sign In</a></p>
                        </div>
                        <!-- /.form-wrapper -->
                    </div>
                    <!-- /.user-data-form -->
        ...
        <!-- isotop -->
        <script src="vendor/isotope.pkgd.min.html"></script>

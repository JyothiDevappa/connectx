...
/**
 * Custom YCX Insights Data (9 items)
 */
$insights = [
    [
            ...
            <div class="blog-grid">
                ...
                <div class="blog-card" data-category="{{ $item['category'] }}">
                    ...
                    <div class="card-content">
                        ...
                        <div class="post-author" style="margin-top: auto; padding-top: 20px; border-top: 1px solid rgba(12,58,48,0.06); display: flex; align-items: center; gap: 10px;">
                            <img src="{{ $item['author']['avatar'] }}" alt="{{ $item['author']['name'] }}" style="width: 36px; height: 36px; border-radius: 50%; object-fit: cover;">
                            <div class="author-info" style="display: flex; flex-direction: column;">
                                <span class="author-name" style="font-weight: 700; font-size: 13px; color: var(--green);">{{ $item['author']['name'] }}</span>
                                <span class="author-role" style="font-size: 10px; color: var(--text-soft);">{{ $item['author']['role'] }}</span>
                            </div>
                        </div>
                    </div>
                </div>

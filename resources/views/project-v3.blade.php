...
<div class="portfolio-two position-relative mt-150 lg-mt-80 mb-150 lg-mb-60">
    <div class="container">
        <div class="position-relative">
            <div id="portfolio-gallery-v3-wrapper" class="column-two">
                        ...
                        <div class="caption">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <h6><a href="{{ url('project-details-v2') }}" class="pj-title">Tax Preparation</a></h6>
                                </div>
                                <div>
                                    <a href="{{ url('project-details-v2') }}" class="arrow tran3s"><i class="bi bi-arrow-up-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="caption">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <h6><a href="{{ url('project-details-v2') }}" class="pj-title">Investment Planning</a></h6>
                                </div>
                                <div>
                                    <a href="{{ url('project-details-v2') }}" class="arrow tran3s"><i class="bi bi-arrow-up-right"></i></a>
                                </div>

...
<head>
    <meta charset="utf-8">
    <title>New Directory Application</title>
    <style>
        body {
...
<div class="container">
    ...
    <div class="content">
        <p class="intro">
            A new application has been submitted for verification to be featured in the <strong>Young Chanakya X Connecters Directory</strong>. Below are the details provided by the applicant:
        </p>

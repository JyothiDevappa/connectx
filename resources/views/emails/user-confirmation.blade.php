...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="message">
            Thank you for applying to be featured in the <strong>Young Chanakya X Connecters Directory</strong>.
            <br><br>
            Our verification team is currently reviewing your submission. Verification and clearance can take up to 2-3 business days. Once approved, your profile will be activated, and you will receive a notification email.
        </div>
        ...
        <div class="details-box">
            ...
            <div class="details-row">
                ...
                <div class="details-value">{{ $full_name }}</div>
            </div>
            <div class="details-row">
                <div class="details-label">Designation</div>
                <div class="details-value">{{ $designation }}</div>
            </div>
            <div class="details-row">
            ...
            <div class="details-row">
                <div class="details-label">Field of Expertise</div>
                <div class="details-value">{{ $expertise }}</div>
            </div>
            <div class="details-row">
                <div class="details-label">LinkedIn URL</div>
                <div class="details-value">{{ $linkedin }}</div>
            </div>
        </div>

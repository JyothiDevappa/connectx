...
<!-- Mirrored from html.creativegigstf.com/babun/babun/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 May 2026 10:16:07 GMT -->
<head>
	<meta charset="UTF-8">
					...
					<div class="d-flex align-items-center justify-content-between">
						<div class="logo order-lg-0">
							<a href="index.html" class="d-flex align-items-center">
								<img src="images/logo/logo_06.html" alt="">
							</a>
						</div>
						<!-- logo -->
						...
						<nav class="navbar navbar-expand-lg p0 ms-lg-5 order-lg-2">
							...
							<div class="collapse navbar-collapse" id="navbarNav">
								<ul class="navbar-nav align-items-lg-center">
									<li class="d-block d-lg-none"><div class="logo"><a href="index.html" class="d-block"><img src="images/logo/logo_06.html" alt=""></a></div></li>
					...
					<div class="col-md-6 wow fadeInLeft">
						<div class="pt-20 pb-50">
							...
							<div class="d-flex flex-wrap">
								<a href="contact.html" class="btn-eighteen tran3s me-4 mt-10">Contact</a>
								<a href="contact.html" class="btn-nineteen tran3s mt-10">Let’s Get Started</a>
							</div>
						</div>
					</div>
                    <div class="col-md-6 d-md-flex justify-content-end wow fadeInRight">
                        <div class="media-wrapper position-relative ms-lg-5">
							<img src="images/lazy.svg" data-src="images/assets/screen_22.svg" alt="" class="lazy-img shapes screen_01">
                            ...
                            <div class="service-slider-one">
								<div class="item">
									<div class="card-style-seventeen d-lg-flex tran3s w-100">
										<div class="icon tran3s rounded-circle d-flex justify-content-center align-items-center"><img src="images/icon/icon_95.html" alt=""></div>
										<div class="text">
								...
								<div class="item">
									<div class="card-style-seventeen d-lg-flex tran3s w-100">
										<div class="icon tran3s rounded-circle d-flex justify-content-center align-items-center"><img src="images/icon/icon_96.html" alt=""></div>
										<div class="text">
			...
			<div class="slider-wrapper">
				<div class="project-slider-one">
					<div class="item">
						<div class="portfolio-block-two">
							<div class="img-wrapper">
								<img src="images/gallery/img_20.html" alt="" class="w-100">
							</div>
							<!-- /.img-wrapper -->
					...
					<div class="item">
						<div class="portfolio-block-two">
							<div class="img-wrapper">
								<img src="images/gallery/img_21.html" alt="" class="w-100">
							</div>
							<!-- /.img-wrapper -->
							<div class="caption d-flex align-items-center justify-content-between flex-wrap">
								<div>
					...
					<div class="item">
						<div class="portfolio-block-two">
							<div class="img-wrapper">
								<img src="images/gallery/img_22.html" alt="" class="w-100">
							</div>
							<!-- /.img-wrapper -->
							<div class="caption d-flex align-items-center justify-content-between flex-wrap">
								<div>
...
<!-- Mirrored from html.creativegigstf.com/babun/babun/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 May 2026 10:16:10 GMT -->
</html>